...
class OstiumAPI:
    ...
    # Path to JSON cache file (generated by internal_analytic/ostium_assets_data.py)
    CACHE_FILE = "ostium_cache.json"
    ...
    def __init__(self):
        ...
        # Use hardcoded fallback values (API data is unreliable)
        self.metadata_cache = self._load_cache()
    
    def _load_cache(self):
        """Return hardcoded fallback values (API data is unreliable)."""
        fallback = {}
        for sym in self.FALLBACK_FEES:
            fallback[sym] = {
                'fee_bps': self.FALLBACK_FEES[sym],
